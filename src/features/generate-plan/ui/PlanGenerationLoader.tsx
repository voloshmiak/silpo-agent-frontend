...
/**
 * Екран очікування генерації. У новому контракті стріму немає token-подій,
 * тож єдиний живий сигнал — tool_call/tool_result. Показуємо рівно один
 * рядок, який змінюється на місці: key={step} перезапускає fade-in.
 */
export const PlanGenerationLoader: React.FC<Props> = ({
  ...
  <div className="w-full max-w-md bg-[#ECE8DC] border border-[#D8D2C2] rounded-2xl p-8 text-center space-y-6">
    ...
    <div className="flex items-center justify-center gap-3 pt-1">
      ...
      <span
        key={step}
        className="plan-step-text font-mono text-sm font-semibold tracking-tight"
        role="status"
        aria-live="polite"
      >
        {step}…
