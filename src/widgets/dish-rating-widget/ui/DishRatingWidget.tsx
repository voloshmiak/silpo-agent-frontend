...
interface Props {
  ...
  onRatingChange: (id: string, score: RatingScore) => void;
  selectedTags: string[];
  onToggleTag: (tag: string) => void;
}

/**
 * Лише збирає відповіді. Зберігаються вони разом із генерацією наступного
 * тижня — цим керує сторінка, щоб оцінки не загубилися між двома кнопками.
 */
export const DishRatingWidget: React.FC<Props> = ({
  meals,
  weekLabel,
  ratings,
  onRatingChange,
